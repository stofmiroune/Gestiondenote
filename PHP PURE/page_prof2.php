  ...
  if (($_SESSION['conexionprof'])=='ok') { $namee=$_SESSION['username'];?>
    ...
    <br><br><br>
        ...
        <div class="inserer_note" id="inserer_note">
          ...
          <form role="form" action="conexprof2.php" method="post" class="login-form">
            <div class="form-group">
              <label>CNE Etudiant</label>
                <input type="text" name="cne" placeholder="CNE Etudiant..." class="form-control" id="">
              </div>

              <div class="form-group">

                <label>Choisir Matiere : <br></label>
                  <input list="matiere" name="matiere" placeholder="Veuillez choisir Web/Complexite..."class="form-control" required>
                  <datalist id="matiere" name="matiere">
                    <option value="web">
                    <option value="complexite">
                  </datalist>
                </div>
